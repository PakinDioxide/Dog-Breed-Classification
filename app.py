...
for root, dirs, files in os.walk('/app/dog-breed-classification/Dog-Breed-Classification'):
    for f in files:
...
st.write(os.listdir('/app/dog-breed-classification/Dog-Breed-Classification'))
